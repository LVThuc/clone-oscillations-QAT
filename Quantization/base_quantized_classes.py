...
class QuantizedModule(nn.Module):
    """
    Lớp cha cho mọi module lượng tử hóa.
    - Cho phép bật/tắt lượng tử hóa cho weights và activations.
    - Quản lý trạng thái lượng tử hóa và range estimator.
    - Định nghĩa các tham số cached và xử lý reset cache.
    """

    def __init__(
        self,
        *args,
        method: QuantizerBase = QuantizationMethod.Asymmetric.cls,
        act_method=None,
        weight_range_method: RangeEstimatorBase = RangeEstimator.CurrentMinMax.cls,
        act_range_method: RangeEstimatorBase = RangeEstimator.RunningMinMax.cls,
        n_bits=8,
        n_bits_act=None,
        ...
        act_discretizer=grad_estimator("EWGS"),
...
class QuantizedActivation(QuantizedModule):
    """
    Module lượng tử hóa activation.
    - Thêm QuantizationManager để quản lý quá trình lượng tử hóa activation.
    - Tự động áp dụng lượng tử hóa nếu _quant_a = True.
    """
