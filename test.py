...
from Quantization.utils import pass_data_for_range_estimation, separate_quantized_model_params
...
def test():
    ...
    optimizer, lr_scheduler = get_optimizer(optimizer = 'sgd', params = quantizer_params + model_params,
	                                        epochs = 100, lr = 0.01, momentum = 0.9, weight_decay = 1e-5)
    print(optimizer)
    print(lr_scheduler)
    ...
    save_checkpoint_dir = "./Model/checkpoints"
